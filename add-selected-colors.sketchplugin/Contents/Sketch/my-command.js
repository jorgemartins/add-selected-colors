...
var documentColors = assets.colorAssets();
var layers = context.selection;

var makeMSColorAsset = function makeMSColorAsset(hex, name) {
  var newMSColor = MSColor.alloc().initWithImmutableModelObject(MSImmutableColor.colorWithSVGString(hex));
